...
describe("Board", () => {
  ...
  it("Passes props from the board to tiles @pass-board-props-to-tiles", () => {
    ...
    expect(
      firstTileProps.color || null,
      "Did you pass the tile object as props to the <Tile>?"
    ).toContain("#");
    expect(
      firstTileProps.selected,
      "Did you pass the tile object as props to the <Tile>?"
    ).toEqual(false);
    expect(
      firstTileProps.matched,
      "Did you pass the tile object as props to the <Tile>?"
    ).toEqual(false);
    expect(
      typeof firstTileProps.svg,
      "Did you pass the tile object as props to the <Tile>?"
    ).toEqual("function");
    expect(
      typeof firstTileProps.id,
      "Did you pass the tile object as props to the <Tile>?"
    ).toEqual("number");
    expect(
      firstTileKey,
    ...
    expect(
      lastTileProps.selected,
      "Did you pass the tile object as props to the <Tile>?"
    ).toEqual(false);
    expect(
      lastTileProps.matched,
      "Did you pass the tile object as props to the <Tile>?"
    ).toEqual(false);
    expect(
      typeof lastTileProps.svg,
      "Did you pass the tile object as props to the <Tile>?"
    ).toEqual("function");
    expect(
      typeof lastTileProps.id,
      "Did you pass the tile object as props to the <Tile>?"
    ).toEqual("number");
    expect(
      lastTileKey,
    ...
    expect(
      tileLength,
      "Did you create an array of <Tile /> components?"
    ).toEqual(12);
  });
});
